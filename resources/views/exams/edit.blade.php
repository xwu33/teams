                          ...
                          <option value="{{$instructor->id}}"
                            @if(old('instructor'))
                              @if($instructor->id == old('instructor'))
                                selected="selected"
                              @endif
                            @elseif($instructor->id == $exam->owner_id)
                              selected="selected"
                            @endif
              ...
              {{ $errors->has('course_name') ? ' has-error' : '' }}">
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <input id="course_name" type="text" class="form-control" name="course_name" value="{{ $exam->course_name }}" placeholder="BSC 999">
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-4 {{ $errors->has('location') ? ' has-error' : '' }}">
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <input id="location" type="text" class="form-control" name="location" value="{{ $exam->location }}" placeholder="Biology Building 127" required>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="col-sm-4{{ $errors->has('date') ? ' has-error' : '' }}">
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <input id="date" type="text" class="form-control" name="date" value="{{ date("m/d/Y", strtotime($exam->date)) }}"  placeholder="Date" required>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-4 {{ $errors->has('start_time') ? ' has-error' : '' }}">
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <input id="start_time" type="text" class="form-control" name="start_time" value="{{ date("g:ia",strtotime($exam->start_time)) }}"  placeholder="Start Time" required>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-4 {{ $errors->has('end_time') ? ' has-error' : '' }}">
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <input id="end_time" type="text" class="form-control" name="end_time" value="{{ date("g:ia",strtotime($exam->end_time)) }}"  placeholder="End Time" required>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-4 {{ $errors->has('max_students') ? ' has-error' : '' }}">
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <input id="max_students" type="text" class="form-control" name="max_students" value="{{ $exam->max_students }}" placeholder="Max Students" required>
                  </div>
                </div>
              </div>
