...
return [
    ...
    */
    'cas_hostname'        => env('CAS_HOSTNAME', 'login.ua.edu'),
    ...
    */
     'cas_real_hosts'      => env('CAS_REAL_HOSTS', 'login.ua.edu'),
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'cas_logout_url'      => env('CAS_LOGOUT_URL', 'https://login.ua.edu/cas/logout'),
